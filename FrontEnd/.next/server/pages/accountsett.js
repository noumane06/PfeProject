...
module.exports = __webpack_require__("Ruu9");
...
// CONCATENATED MODULE: ./pages/accountsett/index.jsx

var accountsett_jsx = external_react_default.a.createElement;
...
const accountSett = props => {
  ...
  if (loading) {
    return accountsett_jsx(external_react_default.a.Fragment, null, accountsett_jsx(head["a" /* default */], {
      title: "Loading"
    }), accountsett_jsx("div", {
      style: {
        position: 'fixed',
    ...
    }, accountsett_jsx(external_antd_["Spin"], {
      size: "large"
    })));
  } else {
    return accountsett_jsx(external_react_default.a.Fragment, null, accountsett_jsx("div", {
      className: "body"
    }, accountsett_jsx("div", {
      className: "ContentInside"
    }, accountsett_jsx(header["a" /* default */], null), accountsett_jsx(head["a" /* default */], {
      title: "Param\xE8tres | 6Solutions"
    }), accountsett_jsx("div", {
      className: "parmHeader"
    }, accountsett_jsx("h1", {
      className: "title"
    }, "Param\xE8tres")), accountsett_jsx("div", {
      className: "parmBody"
    }, accountsett_jsx(external_antd_["Menu"], {
      onClick: handleClick,
    ...
    }, accountsett_jsx(external_antd_["Menu"].Item, {
      key: "Account",
      style: {
        fontWeight: 'bolder'
      }
    }, "Compte"), accountsett_jsx(external_antd_["Menu"].Item, {
      key: "Privacy",
      style: {
        fontWeight: 'bolder'
      }
    }, "Confidentialit\xE9 et conditions de service"))), accountsett_jsx("div", {
      className: "MenuContent"
    }, current === "Account" && accountsett_jsx(external_react_default.a.Fragment, null, accountsett_jsx(account_Components_AccountComp, {
      profile: data
    })), current === "Privacy" && accountsett_jsx(external_react_default.a.Fragment, null)), accountsett_jsx("div", {
      className: "DeleteAccount"
    }, accountsett_jsx("div", null, accountsett_jsx(trashSvg, null), accountsett_jsx("span", null, "Supprimez votre compte"))))), accountsett_jsx(footer["a" /* default */], null));
  }
};
...
/* harmony default export */ var accountsett = __webpack_exports__["default"] = (accountSett);
