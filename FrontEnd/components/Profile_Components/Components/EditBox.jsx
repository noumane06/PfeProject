    ...
    const handleChange = (event)=>{
        ...
        return(
            <div className="EditBox">
                ...
                <textarea className="textArea" name="presentation" placeholder={data.type !== "Société" ? "Parlez-nous de vous (optionnel)" : "Décrivez votre entreprise"} rows="4" value={data.presentation} onChange={handleChange} /><br/><br/>
                {/*  ------------------------------------------------------------------------------------------ */}
