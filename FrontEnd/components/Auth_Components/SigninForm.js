      ...
      <div className="FormContainer">
          ...
          {!Loggedin  && (
            ...
            <form onSubmit={handleSubmit}>
              <label>Email</label>
              <br />
              <input className={emailErr ? "input error" : "input"} style={{width : '80%'}} type="email" name="email" onChange={handleChange} value={userData.email} required/>
              <br />
              <label className={emailErr ? "errMsg" : "hidden"}>email invalide</label><br />
              <br />
              <label>Mode de passe</label>
              <br />
              <input className={passwordErr ? "input error" : "input"} style={{width : '80%'}} type="password" name="password" onChange={handleChange} value={userData.password} required />
              <br />
